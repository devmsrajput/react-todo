  ...
  return (
    <>
      <label className="themeSwitcherThree relative inline-flex cursor-pointer select-none items-center">
        ...
        />
        <div className="shadow-card flex h-[46px] w-[82px] items-center justify-center rounded-md bg-slate-300 dark:bg-slate-700">
          <span
            className={`flex h-9 w-9 items-center justify-center rounded ${
              themeMode === "light" ? "bg-slate-400" : "text-white"
            }`}
          >
            <svg
              width="16"
